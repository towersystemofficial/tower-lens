...
| Camera/OCR | Camera preview opens; capture/freeze produces editable recognized text; cancel/back works | **In progress** — Pixel 9a, 2026-07-22; camera permission, live preview, capture/freeze, OCR output, and editing recognized text passed. Cancel/back still to test |
