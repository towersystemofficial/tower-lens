...
| Camera denial/recovery | Deny camera safely, then grant it and retry without reinstalling | **In progress** — Pixel 9a, 2026-07-22; after permission was revoked in Android Settings, reopening the scanner returned to the Android camera-permission prompt without crashing. Grant-and-retry still to test |
