...
| ToS | Paste text, run summary, read output, save, and reopen from Library | **In progress** — Pixel 9a, 2026-07-22; paste/input, loading state, structured mock summary, and save confirmation passed. Reopen from Library still to test |
