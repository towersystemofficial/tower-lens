...
| Watchlist | Add/remove entries; matching and non-matching ingredient checks behave correctly | **Pass** — Pixel 9a, 2026-07-22; adding `peanut` succeeded, a scanned peanut bag triggered the expected warning, an unrelated scanned item produced no warning, and removing `peanut` prevented the warning when the peanut bag was scanned again |
