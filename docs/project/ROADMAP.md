...
| Camera/OCR | Camera preview opens; capture/freeze produces editable recognized text; cancel/back works | **In progress** — Pixel 9a, 2026-07-22; camera permission granted and live preview appeared. Capture/freeze, OCR text editing, and cancel/back still to test |
