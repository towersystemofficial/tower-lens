...
| Watchlist | Add/remove entries; matching and non-matching ingredient checks behave correctly | **In progress** — Pixel 9a, 2026-07-22; adding `peanut` succeeded, a scanned peanut bag triggered the expected warning, and an unrelated scanned item produced no warning. Removal still to test |
